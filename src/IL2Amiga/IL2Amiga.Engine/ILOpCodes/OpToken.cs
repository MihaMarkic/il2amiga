...
namespace IL2Amiga.Engine.ILOpCodes
{
    public class OpToken : ILOpCode
    {
        ...
        public OpToken(Code aOpCode, int aPos, int aNextPos, int aValue, Module aModule, Type[] aTypeGenericArgs, Type[] aMethodGenericArgs, ExceptionRegionInfoEx? aCurrentExceptionRegion)
