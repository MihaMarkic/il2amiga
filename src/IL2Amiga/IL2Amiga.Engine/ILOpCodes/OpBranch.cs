...
namespace IL2Amiga.Engine.ILOpCodes
{
    public class OpBranch : ILOpCode
    {
        ...
        public OpBranch(Code aOpCode, int aPos, int aNextPos, int aValue, ExceptionRegionInfoEx? aCurrentExceptionRegion)
        ...
        public override void DoInterpretStackTypes()
        {
            ...
            switch (OpCode)
            {
                ...
                case Code.Brfalse:
                    ...
                    // ECMA apparently sees a boolean on the stack as a native int. We push as boolean, so accept that as well
